...
index 0b5ade0..36bae19 100644
--- a/src/EVault/modules/Governance.sol
+++ b/src/EVault/modules/Governance.sol
@@ -391,6 +391,14 @@ abstract contract GovernanceModule is IGovernance, BalanceUtils, BorrowUtils, LT
 
         emit GovSetInterestFee(newInterestFee);
     }
+
+    function setInterestFee() public virtual nonReentrant governorOnly {
+        
+        uint16 newInterestFee = 0;
