...
@@ -111,7 +111,7 @@ abstract contract GovernanceModule is IGovernance, BalanceUtils, BorrowUtils, LT
     }
 
     /// @inheritdoc IGovernance
-    function protocolConfigAddress() public view virtual reentrantOK returns (address) {
+    function protocolConfigAddress() public view virtual nonReentrantView returns (address) {
