...
@@ -171,7 +171,7 @@ abstract contract GovernanceModule is IGovernance, BalanceUtils, BorrowUtils, LT
     }
 
     /// @inheritdoc IGovernance
-    function liquidationCoolOffTime() public view virtual reentrantOK returns (uint16) {
+    function liquidationCoolOffTime() public view virtual reentrantOK governorOnly returns (uint16) {
