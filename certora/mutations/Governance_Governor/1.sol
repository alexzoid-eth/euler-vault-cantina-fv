...
@@ -313,7 +313,7 @@ abstract contract GovernanceModule is IGovernance, BalanceUtils, BorrowUtils, LT
     }
 
     /// @inheritdoc IGovernance
-    function setMaxLiquidationDiscount(uint16 newDiscount) public virtual nonReentrant governorOnly {
+    function setMaxLiquidationDiscount(uint16 newDiscount) public virtual nonReentrant {
