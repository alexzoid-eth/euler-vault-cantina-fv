...
@@ -208,7 +208,7 @@ abstract contract GovernanceModule is IGovernance, BalanceUtils, BorrowUtils, LT
     }
 
     /// @inheritdoc IGovernance
-    function convertFees() public virtual nonReentrant {
+    function convertFees() public virtual nonReentrant governorOnly {
